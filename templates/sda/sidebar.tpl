<div class="span3" style="margin-left:15px;">
              ...
              {else}
              <p style="padding-bottom:10px;">Anda sudah login sebagai : {$smarty.session.nama}<br /><a href="logout.php"><input type="button" class="m-btn blue-stripe" value="Logout" /></a></p>
              {/if}
              </div>
           </div>
   ...
   <li><a href='hidrologi.html'><span>POS Hidrologi</span></a></li>
                   	...
                   	<div class="widget">
                        <div class="textwidget">
                        	<a href="http://sda.pu.go.id/" target="_blank"><img src="{$images}/link_ditjen.jpg" alt="" width="270" /></a>
                        </div>
                   </div>
                   
                   <div class="widget">
                        <div class="textwidget">
                        	<a href="http://pu.kaltimprov.go.id/" target="_blank"><img src="{$images}/link_pu.jpg" alt="" width="270" /></a>
                        </div>
                   </div>
                   
                    <div class="widget">
                        <div class="textwidget">
                        	<a href="http://bwskal2.pdsda.net/" target="_blank"><img src="{$images}/link_bws.jpg" alt="" width="270" /></a>
                        </div>
                   </div>
                   
                   <div class="widget">
                        <div class="textwidget">
                        	<a href="http://www.lapanrs.com/home" target="_blank"><img src="{$images}/lapan.jpg" alt="" width="270" /></a>
                        </div>
                   </div>
