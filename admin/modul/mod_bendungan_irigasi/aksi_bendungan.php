...
// Hapus Bendungan
if ($module=='bendungan' AND $act=='hapus'){
  $data=mysql_fetch_array(mysql_query("SELECT booklet FROM bendungan WHERE id_bendung='$_GET[id]'"));
  if ($data['booklet']!=''){
...
// Input Bendung
elseif ($module=='bendungan' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    echo "<script>window.alert('Upload Gagal, Pastikan File yang di Upload bertipe *.JPG');
        window.location=('../../media.php?module=bendungan)</script>";
    }
    else{
...
// Update Bendung
elseif ($module=='bendungan' AND $act=='update'){
  $lokasi_file    = $_FILES['fupload']['tmp_name'];
  $tipe_file      = $_FILES['fupload']['type'];
  $nama_file      = $_FILES['fupload']['name'];
  ...
  if (empty($lokasi_file)){
    mysql_query("UPDATE bendungan SET  kode_bendung				= '$_POST[kode]',
									   ...
									   panjang_bendung			= '$_POST[panjang]',
									   kapasitas_tampung		= '$_POST[kapasitas]',
