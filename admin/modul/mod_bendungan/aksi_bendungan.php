...
// Hapus Bendungan
if ($module=='bendunganairbaku' AND $act=='hapus'){
...
// Input Bendung
elseif ($module=='bendunganairbaku' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    echo "<script>window.alert('Upload Gagal, Pastikan File yang di Upload bertipe *.JPG');
        window.location=('../../media.php?module=bendunganairbaku)</script>";
    }
    else{
...
// Update Bendung
elseif ($module=='bendunganairbaku' AND $act=='update'){
  $lokasi_file    = $_FILES['fupload']['tmp_name'];
  $tipe_file      = $_FILES['fupload']['type'];
  $nama_file      = $_FILES['fupload']['name'];
