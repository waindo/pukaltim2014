...
// Hapus bendungairbaku
if ($module=='bendungairbaku' AND $act=='hapus'){
...
// Input bendungairbaku
elseif ($module=='bendungairbaku' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    echo "<script>window.alert('Upload Gagal, Pastikan File yang di Upload bertipe *.JPG');
        window.location=('../../media.php?module=bendungairbaku)</script>";
    }
    else{
...
// Update bendungairbaku
elseif ($module=='bendungairbaku' AND $act=='update'){
  $lokasi_file    = $_FILES['fupload']['tmp_name'];
  $tipe_file      = $_FILES['fupload']['type'];
  $nama_file      = $_FILES['fupload']['name'];
