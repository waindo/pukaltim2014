...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2014 at 09:56 AM
...
INSERT INTO `debit_air` (`id`, `waktu`, `ws`, `jumlah`) VALUES
(4, '2011-01-01', 'WS Berau Kelai', 6),
(5, '2011-02-01', 'WS Berau Kelai', 6),
(6, '2011-03-01', 'WS Berau Kelai', 4),
(7, '2011-04-01', 'WS Berau Kelai', 3),
(8, '2011-05-01', 'WS Berau Kelai', 5),
(9, '2011-06-01', 'WS Berau Kelai', 7),
(10, '2011-07-01', 'WS Berau Kelai', 5),
(11, '2011-08-01', 'WS Berau Kelai', 6),
(12, '2011-09-01', 'WS Berau Kelai', 8),
(13, '2011-10-01', 'WS Berau Kelai', 6),
(14, '2011-11-01', 'WS Berau Kelai', 3),
(15, '2011-12-01', 'WS Berau Kelai', 3),
(16, '2014-09-00', 'WS Kendilo', 5),
(17, '1995-03-00', 'WS Berau Kelai', 2),
(18, '2005-12-00', 'WS Berau Kelai', 2);
...
CREATE TABLE IF NOT EXISTS `ds` (
  `kodews` int(2) NOT NULL,
  `kodedas` int(3) NOT NULL,
  `nama` varchar(50) NOT NULL,
  PRIMARY KEY (`kodews`,`kodedas`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ds` (`kodews`, `kodedas`, `nama`) VALUES
(1, 11, 'das berau1'),
(1, 12, 'das berau2'),
(2, 21, 'das selayar1'),
(2, 22, 'das selayar2');
...
--
-- Table structure for table `keb_air`
--

CREATE TABLE IF NOT EXISTS `keb_air` (
...
--
-- Dumping data for table `keb_air`
--

INSERT INTO `keb_air` (`id`, `waktu`, `ws`, `jenis`, `jumlah`) VALUES
(7, '2011-01-01', 'WS Berau Kelai', 'Domestik', 2.5),
(8, '2011-02-01', 'WS Berau Kelai', 'Domestik', 3.5),
(9, '2011-03-01', 'WS Berau Kelai', 'Domestik', 3.1),
(10, '2011-04-01', 'WS Berau Kelai', 'Domestik', 3.9),
(11, '2011-05-01', 'WS Berau Kelai', 'Domestik', 4.5),
(12, '2011-06-01', 'WS Berau Kelai', 'Domestik', 5),
(16, '2011-10-01', 'WS Berau Kelai', 'Domestik', 6),
(17, '2011-09-01', 'WS Berau Kelai', 'Domestik', 5),
(18, '2011-11-01', 'WS Berau Kelai', 'Domestik', 5),
(20, '2011-07-01', 'WS Berau Kelai', 'Domestik', 6),
(21, '2011-08-01', 'WS Berau Kelai', 'Domestik', 6),
(22, '2011-12-01', 'WS Berau Kelai', 'Domestik', 5),
(28, '2014-09-00', 'WS Kendilo', 'Irigasi', 5),
(29, '2014-09-00', 'WS Berau Kelai', 'Irigasi', 3),
(31, '2006-03-00', 'WS Berau Kelai', 'Domestik', 2),
(32, '2005-02-00', 'WS Karangan', 'Irigasi', 2),
(33, '2014-01-00', 'WS Berau Kelai', 'Industri', 2);
...
(15, 'agung nugroho', 'res', '2014-08-11 10:40:02', 'Banjir', '20 > 40 cm', 'Cerah ', 'Tersendat', 'wwww', 'www'),
(16, 'agung', ' tes 85', '2014-09-09 08:53:31', '', '', '', '', '', '');
...
(63, 'air', '?module=air', '', '', 'Y', 'admin', 'Y', 33, '');
...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', 'admin@detik.com', '08238923848', 'admin', 'N', 'i8s4p5qr8jf80ujmgg73qglkf3');
...
CREATE TABLE IF NOT EXISTS `ws` (
  `kodews` int(2) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL,
  PRIMARY KEY (`kodews`)
...
INSERT INTO `ws` (`kodews`, `nama`) VALUES
(1, 'wilayah berau'),
(2, 'wilayah selayar');
